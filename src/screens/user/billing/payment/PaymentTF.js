...
const PaymentTF = ({trx}) => {
  ...
  const pay = async () => {
    ...
    console.log(`/user/${user_data.user_id}/billing/${trx.trxno}/payment/tf`);
    await api
      .post(
        `/user/${user_data.user_id}/billing/${trx.trxno}/payment/tf`,
        {},
        {
          headers: {
  ...
  return (
    <>
      <HeaderBack
        ...
        search={false}
        back={() => navigation.replace('BillingView', {trxno: trx.trxno})}
      />
      {loading ? (
        <View>
        ...
        <>
            ...
            <Card
              ...
              <View
                ...
                <Text
                  ...
                  Rp{currencyFormat(trx.price)}
                </Text>
                <TouchableOpacity
                  onPress={() => {
                    Clipboard.setString(String(trx.price));
                    RNToasty.Show({
                      title: 'Disalin ke papan klip',
                      position: 'center',
                    });
          ...
          <View style={{margin: 16, zIndex: 1}}>
            ...
            <Button
              ...
              mode="contained"
              onPress={() =>
                navigation.replace('BillingView', {trxno: trx.trxno})
              }>
              Selesai
            </Button>
          </View>
